...
namespace ModeloPrimerParcial
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            PrestamoDolar pd2 = new PrestamoDolar(2000, new DateTime(2057, 12, 05),
            PeriodicidadDePagos.Bimestral);
            PrestamoDolar pd3 = new PrestamoDolar(2500, new DateTime(2068, 01, 01),
            ...
            pd1.ExtenderPlazo(new DateTime(2018, 10, 04));
            pp1.ExtenderPlazo(new DateTime(2018, 10, 06));
